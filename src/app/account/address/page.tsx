...
export default function AddressPage() {
    ...
    const handleDeleteConfirm = async () => {
        ...
        if (!error) {
            ...
            // close edit form if it was open for this address
                        ...
                        {addresses.map((address) => (
                            <div key={address.id} className="border border-gray-200 rounded-md p-4">
                                <p className="font-semibold">
                                    ...
                                    {address.is_default && <span className="text-sm text-green-800 font-medium">(Default)</span>}
                                </p>
                                ...
                                {editAddressId === address.id && (
                                    <div className="mt-6">
                                        ...
                                        <AddressForm userId={user!.id} initialData={address} onSuccess={handleAddressUpdated} />
                                    </div>
                                )}
                            </div>
                        ))}
